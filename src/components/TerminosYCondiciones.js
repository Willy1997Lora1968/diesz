...
function TerminosYCondiciones() {
  return (
    <div className="terminosYCondiciones">
      ...
      <p>¡Bienvenido a HM & LEI!</p>
      <p>
        Estos términos y condiciones describen las reglas y regulaciones para el
        uso del sitio web de HM & LEI, ubicado en HM & LEI.com.
      </p>
      <p>
        Al acceder a este sitio web, asumimos que aceptas estos términos y
        condiciones. No continúes usando HM & LEI si no estás de acuerdo con
      ...
      <p>
        ...
        en línea. Al acceder a HM & LEI, aceptaste utilizar las cookies
        necesarias.
      </p>
      <p>
      ...
      <p>
        Tienes la capacidad de aceptar o rechazar cookies opcionales. Hay
        algunas cookies obligatorias que son necesarias para el funcionamiento
        de nuestro sitio web. Estas cookies no requieren tu consentimiento ya
        que siempre funcionan. Ten en cuenta que al aceptar las cookies
        requeridas, también aceptas las cookies de terceros, que podrían usarse
        a través de servicios proporcionados por terceros si utilizas dichos
        servicios en nuestro sitio web, por ejemplo, una ventana de
        visualización de video proporcionada por terceros e integrada en nuestro
        sitio web.
      </p>
      <h2>Licencia</h2>
      <p>
        A menos que se indique lo contrario, HM & LEI y/o sus licenciantes
        poseen los derechos de propiedad intelectual de todo el material en HM &
        LEI. Todos los derechos de propiedad intelectual son reservados. Puedes
        acceder desde HM & LEI para tu uso personal sujeto a las restricciones
        establecidas en estos términos y condiciones.
      </p>
      <h2>Hipervínculos a nuestro contenido</h2>
      <p>Las siguientes organizaciones pueden vincularse a nuestro sitio...</p>
      <h2>No debes</h2>
      <ul>
        <li>Copiar o volver a publicar material de HM & LEI</li>
        <li>Vender, alquilar o sublicenciar material de HM & LEI</li>
        <li>Reproducir, duplicar o copiar material de HM & LEI</li>
        <li>Redistribuir contenido de HM & LEI</li>
        <li>Este acuerdo comenzará el fecha presente.</li>
      </ul>
      <p>
        ...
        HM & LEI no filtra, edita, publica ni revisa los comentarios antes de su
        presencia en el sitio web. Los comentarios no reflejan los puntos de
        vista ni las opiniones de HM & LEI, sus agentes y/o afiliados. Los
        comentarios reflejan los puntos de vista y opiniones de la persona que
        publica. En la medida en que lo permitan las leyes aplicables, HM & LEI
      ...
      <p>
        Por la presente, otorgas a HM & LEI una licencia no exclusiva para usar,
      ...
      <h2>Organizaciones que pueden enlazar a nuestro sitio web</h2>
      <p>
        ...
        y/o servicios; y (c) encaje en el contexto del sitio de la parte
        vinculante.
      </p>
      <h2>Solicitudes de enlaces de ciertos tipos de organizaciones</h2>
      <p>
      ...
      <p>
        ...
        del hipervínculo compensa la ausencia de HM & LEI; y (d) el enlace está
      ...
      <p>
        ...
        sus productos o servicios; y (c) encaje en el contexto del sitio de la
        parte vinculante.
      </p>
      <p>
        ...
        un correo electrónico a HM & LEI. Incluye tu nombre, el nombre de tu
      ...
      <p>
        No se permitirá el uso del logotipo de HM & LEI u otro material gráfico
